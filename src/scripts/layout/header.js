...
const header = () => {
  ...
  const menuToggle = createNewElement('button', { classes: ['menu-toggle', 'icon__menu', 'button'] });
  const pageTitle = createNewElement('div', { classes: 'page-title' });
  const pageTitleIcon = createNewElement('span', { classes: ['page-title__icon', 'icon__todo'] });
